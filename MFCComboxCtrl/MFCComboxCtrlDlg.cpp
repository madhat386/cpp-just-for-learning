...
// MFCComboxCtrlDlg.cpp: 实现文件
//

#include "pch.h"
#include "framework.h"
#include "MFCComboxCtrl.h"
#include "MFCComboxCtrlDlg.h"
...
// CMFCComboxCtrlDlg 对话框



CMFCComboxCtrlDlg::CMFCComboxCtrlDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFCCOMBOXCTRL_DIALOG, pParent) {
...
// CMFCComboxCtrlDlg 消息处理程序

BOOL CMFCComboxCtrlDlg::OnInitDialog() {
...
void CMFCComboxCtrlDlg::OnSysCommand(UINT nID, LPARAM lParam) {
...
void CMFCComboxCtrlDlg::OnPaint() {
	if (IsIconic()) {
...
//显示。
HCURSOR CMFCComboxCtrlDlg::OnQueryDragIcon() {
	return static_cast<HCURSOR>(m_hIcon);
}



void CMFCComboxCtrlDlg::OnOK() {
